...
public class EatInOrderLineItemPrice {
    ...
    public static final String ERROR_MESSAGE_PRICE = "주문 항목 가격은 0원 이상 이어야 합니다.";
    public static final int MINIMUM_PRICE = 0;

    private BigDecimal value;

    public EatInOrderLineItemPrice(final BigDecimal value) {
        validate(value);
        this.value = value;
    }
    ...
    public boolean equals(Object object) {
        ...
        EatInOrderLineItemPrice that = (EatInOrderLineItemPrice) object;
